...
public class R<T> implements Serializable {
     ...
     * 没有对应权限
     */
    public static final int PERM_INTER = 11013;
    ...
    public static <T> R<T> permInter(String message) {
        return restResult(null, PERM_INTER, message, TYPE_WARN);
    }

    public static <T> R<T> NullPointer() {
        return restResult(null, WARN, "空指针异常", TYPE_WARN);
    }

    public static <T> R<T> missParam() {
        return restResult(null, WARN, "请求缺少参数", TYPE_WARN);
    }
